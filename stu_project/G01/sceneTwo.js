class sceneTwo extends Phaser.Scene {
    ...
    preload() {
        this.load.atlas('megaset', 'img/megaset-0.png', 'http://labs.phaser.io/assets/atlas/megaset-0.json');
//------------wall 
...
//------------加速情況下的鍵盤控制playerMove
            if (moveup == true ) {
                ...
                if (this.initialTime == movetime - 10 || movedown==true ||this.initialTime ==0)
                {
                    moveup = false;
                    particles.destroy();
                }
...
//------------減速情況下的鍵盤控制playerMove
            if (movedown == true ) {
                ...
                if (this.initialTime == movetime - 10 || moveup==true ||this.initialTime ==0) {
