...
function preload()
{
    ...
    this.load.spritesheet('player down walk left (mask)', '/player img/player down walk left (mask).png', {frameWidth: 100, frameHeight: 100});
    this.load.spritesheet('player down walk left', '/player img/player down walk left.png', {frameWidth: 100, frameHeight: 100});
    this.load.spritesheet('player down walk right (mask)', '/player img/player down walk right (mask).png', {frameWidth: 100, frameHeight: 100});
    this.load.spritesheet('player down walk right', '/player img/player down walk right.png', {frameWidth: 100, frameHeight: 100});
    ...
    this.load.spritesheet('player slide left (mask)', '/player img/player slide left (mask).png', {frameWidth: 100, frameHeight: 100});
    this.load.spritesheet('player slide left', '/player img/player slide left.png', {frameWidth: 100, frameHeight: 100});
    this.load.spritesheet('player slide right (mask)', '/player img/player slide right (mask).png', {frameWidth: 100, frameHeight: 100});
    this.load.spritesheet('player slide right', '/player img/player slide right.png', {frameWidth: 100, frameHeight: 100});
