...
;(function ($, window, document, undefined) {
    ...
    TWzipcode.prototype = {
        ...
        serialize: function init() {
            ...
            if (obj.length) {
                obj.each(function init() {
                    ele = $(this);
                    result.push(ele.attr('name') + '=' + ele.val());
                });
            } else {
                $(this).children().each(function init() {
                    s = $(this);
        ...
        bindings: function init() {
            ...
            // county
            wrap.county.on('change.twzipcode', function init() {
                var val = $(this).val(),
                    district = '',
                    tpl = [];
            ...
            // District
            wrap.district.on('change.twzipcode', function init() {
                var val = $(this).val();
                if (wrap.county.val()) {
            ...
            // Zipcode
            wrap.zipcode.on('keyup.twzipcode blur.twzipcode', function init() {
